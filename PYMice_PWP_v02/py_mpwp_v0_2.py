...
# Example of an for npz file as made from provided scripts.
    ...
    cd_air = 1e-3
#   cd_air=0.125(0.10+0.13*U_a_series-0.0022*U_a_series**2)*10**(-3)
...
###########################################
# to do make this just npz or another
profload=0
