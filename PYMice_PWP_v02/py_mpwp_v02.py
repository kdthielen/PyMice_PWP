...
parser.add_option("--params",dest="param_name",
                      default="params.py",
                      help="name of paramater file to be used, default is params.py")
...
params_load=str(options.param_name)
execfile(params_load)
...
while iteration<maxiter:
    ...
    ISW_ice = 0#pypwp.sw_downwelling(sw,si_albedo)
    ...
    if kt_switch==1:
        fw_flux= salt[0]*(((1.-A)*emp))-sw_flux*dz/dt
        temp_flux=(1.-A)*(q_out-q_in*0.45)/(rho_ocean_ref*cp_ocean)-t_flux*dz/dt
